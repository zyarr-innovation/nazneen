...
export class DataService {
  ...
  caseDetailUrl = 'http://localhost:8000/casedetail'; ///:case_id
  ...
  getCase(case_id: number): Observable<ICase> {
    let username = this.authService.getLoginUser();
    return this.httpClient.get<ICase>(this.caseDetailUrl + `/${case_id}`);
  }
  ...
  addCase(
    ...
    let newCase: ICase = {
      ...
      comment_status: EnumCommentStatus.new,
      username: username!,
      communication: []
    }
